                    ...
                    <div class="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
                        <div class="relative hidden w-full items-center justify-center bg-[linear-gradient(225deg,rgba(239,18,98,1)_0%,rgba(67,97,238,1)_100%)] p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-32 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                            ...
                            <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                                <a href="" class="block w-50 lg:w-72 ms-10">
    <img src="assets/images/auth/coba.jpeg" alt="Logo" class="w-full rounded-full">
</a>
                        ...
                        <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                            <div class="flex w-full max-w-[440px] items-center gap-2 lg:absolute lg:end-6 lg:top-6 lg:max-w-full">
                                <a href="{{ '/admin.dashboard' }}" class="block w-8 lg:hidden">
...
<form class="space-y-5 dark:text-white" action="{{ route('login.authenticate') }}"
                                method="POST">
                                @csrf                                    <div>
                                ...
                                <div class="mb-10 md:mb-[60px]">
                                    <ul class="flex justify-center gap-3.5">
                                        <li>
                                            <a href="https://instagram.com/aldsplnzr" target="_blank" class="inline-flex h-8 w-8 items-center justify-center rounded-full p-0 transition hover:scale-110" style="background: linear-gradient(135deg, rgba(239, 18, 98, 1) 0%, rgba(67, 97, 238, 1) 100%)">
                                        ...
                                        <li>
                                            <a href="https://facebook.com/aldisaefulnizar" target="_blank" class="inline-flex h-8 w-8 items-center justify-center rounded-full p-0 transition hover:scale-110" style="background: linear-gradient(135deg, rgba(239, 18, 98, 1) 0%, rgba(67, 97, 238, 1) 100%)">
                                        ...
                                        <li>
                                            <a href="https://tiktok.com/@aldyysn3" target="_blank" class="inline-flex h-8 w-8 items-center justify-center rounded-full p-0 transition hover:scale-110" style="background: linear-gradient(135deg, rgba(239, 18, 98, 1) 0%, rgba(67, 97, 238, 1) 100%)">
                                                <svg width="14" height="12" viewBox="0 0 24 24"  fill="none">
                <path d="M19 7.5c-1.5 0-2.8-.5-3.9-1.4V15c0 3-2.4 5.5-5.5 5.5S4 18 4 15s2.4-5.5 5.5-5.5c.3 0 .7 0 1 .1v2.8c-.3-.1-.7-.2-1-.2-1.5 0-2.7 1.2-2.7 2.7S8 17.6 9.5 17.6 12.2 16.4 12.2 15V2h2.9c.2 2 1.7 3.6 3.9 3.8v1.7z" fill="white"/>
                                                </svg>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://youtube.com/@jamet1572" target="_blank" class="inline-flex h-8 w-8 items-center justify-center rounded-full p-0 transition hover:scale-110" style="background: linear-gradient(135deg, rgba(239, 18, 98, 1) 0%, rgba(67, 97, 238, 1) 100%)">
                                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                                                                    <path d="M23.5 6.2s-.2-1.6-.8-2.3c-.8-.9-1.7-.9-2.1-1C17.6 2.7 12 2.7 12 2.7h0s-5.6 0-8.6.2c-.4.1-1.3.1-2.1 1C.7 4.6.5 6.2.5 6.2S.3 8 .3 9.8v1.7C.3 13.3.5 15 .5 15s.2 1.6.8 2.3c.8.9 1.9.9 2.4 1 1.7.2 7.3.2 7.3.2s5.6 0 8.6-.2c.4-.1 1.3-.1 2.1-1 .6-.7.8-2.3.8-2.3s.2-1.7.2-3.5V9.8c0-1.8-.2-3.6-.2-3.6zM9.8 14.5V7.5l6.2 3.5-6.2 3.5z" fill="white"/>
